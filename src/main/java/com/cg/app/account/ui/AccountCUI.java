...
public class AccountCUI {
	...
	private void deposit() {
		...
		SavingsAccount savingsAccount = null;
			...
			//DBUtil.commit();
		/*
		 * } catch (ClassNotFoundException | SQLException e) { e.printStackTrace(); try
		 * { //DBUtil.rollback(); } catch (SQLException e1) { e1.printStackTrace(); } }
		 * catch (Exception e) { try { //DBUtil.rollback(); } catch (SQLException e1) {
		 * e1.printStackTrace(); } }
		 */
	}
	...
	/*
	 * private static void sortMenu() { do {
	 ...
	 * }
	 * 
	 * private static void showSortedAccount(int choice) { Set<SavingsAccount>
	 * sortedAccounts; try { sortedAccounts =
	 * savingsAccountService.getSortedAccounts(choice); for (SavingsAccount
	 * savingsAccount : sortedAccounts) { System.out.println(savingsAccount); } }
